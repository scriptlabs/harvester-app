...
@section('js_after')
    ...
    <!-- Page JS Code -->
    <script src="{{ mix('js/pages/db_dark.js') }}"></script>
@endsection
    ...
    <div class="content content-top">
      <div class="row invisible" data-toggle="appear">
        ...
        <div class="col-6 col-xl-3">
          <a class="block block-rounded block-bordered text-right" href="javascript:void(0)">
        ...
        <div class="col-6 col-xl-3">
          <a class="block block-rounded block-bordered text-body-color-dark text-right" href="javascript:void(0)">
            <div class="block-content block-content-full clearfix">
              <div class="float-left mt-10 d-none d-sm-block">
        ...
        <div class="col-md-6">
          <div class="block block-rounded block-bordered">
            ...
            <div class="block-content block-content-full">
              <div class="pull-all">
                <!-- Lines Chart Container functionality is initialized in js/pages/db_dark.min.js which was auto compiled from _js/pages/db_dark.js -->
      ...
      <div class="row invisible" data-toggle="appear">
        <!-- Row #4 -->
        <div class="col-md-6">
          <a class="block block-rounded block-bordered text-body-color-dark overflow-hidden" href="javascript:void(0)">
            <div class="block-content block-content-full">
      ...
      <div class="row invisible" data-toggle="appear">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <a class="block block-rounded block-bordered text-body-color-dark text-center" href="be_pages_generic_inbox.html">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <a class="block block-rounded block-bordered text-body-color-dark text-center" href="be_pages_generic_profile.html">
            <div class="block-content">
              <p class="mt-5">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <a class="block block-rounded block-bordered text-body-color-dark text-center" href="be_pages_forum_categories.html">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <a class="block block-rounded block-bordered text-body-color-dark text-center" href="be_pages_generic_search.html">
            <div class="block-content">
              <p class="mt-5">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <a class="block block-rounded block-bordered text-body-color-dark text-center" href="be_comp_charts.html">
            <div class="block-content">
              <p class="mt-5">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <a class="block block-rounded block-bordered text-body-color-dark text-center" href="javascript:void(0)">
            <div class="block-content">
              <p class="mt-5">
