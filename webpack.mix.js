...
mix
    ...
    .js('resources/js/pages/db_dark.js', 'public/js/pages/db_dark.js')
    .js('resources/js/pages/op_auth_signin.js', 'public/js/pages/op_auth_signin.js')
    .js('resources/js/pages/op_auth_signin.js', 'public/js/pages/op_auth_signup.js')
    .js('resources/js/pages/op_auth_signin.js', 'public/js/pages/op_auth_reminder.js')
    .js('resources/js/pages/op_auth_signin.js', 'public/js/pages/op_auth_lock.js')
